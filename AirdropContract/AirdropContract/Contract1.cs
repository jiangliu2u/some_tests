...
namespace AirdropContract
{
	public class AirdropContract : SmartContract
	{
		...
		private const Int64 TOTAL_AMOUNT_PER_PHASE = 279015210000;
		private const Int64 TOTAL_AIRDROP_AMOUNT = 837045630000;
		...
		private const int SECONDS_PER_DAY = 8600;
		private const int PERIOD = 730;
		private const int COMPENSATE_TIME = 8699;
